          ...
          <div className="flex flex-wrap lg:flex-nowrap items-center justify-center lg:justify-between gap-y-0 lg:gap-0 w-full min-w-0 py-1 sm:py-1">
            ...
            <AttributeSelector
              ...
              shapes={{
                ...
                'Inverted Triangle': 'M4 4L20 4L12 20L4 4Z',
                'Trapezoid': 'M6 4H18L16 20H8L6 4Z',
                'Oval': 'M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2Z'
              }}
            />
