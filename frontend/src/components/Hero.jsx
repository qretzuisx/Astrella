...
const Hero = () => {
  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
      ...
      <form className="flex flex-wrap md:flex-row items-start md:items-center justify-center gap-3 bg-white p-4 md:rounded-full rounded-2xl shadow-[0_8px_20px_rgba(0,0,0,0.1)] w-[49%] max-w-[850px]">
        ...
        <div className="flex flex-col items-start gap-2">
         ...
         <button
          ...
          className="bg-primary text-white px-4 py-3
           rounded-full font-medium hover:bg-primary-dull transition-all">
